...
<div class="row justify-content-center">
    <div class="col-lg-8">
        ...
        <div class="mb-4">
            ...
            <p class="text-muted small mb-0">Perbarui informasi akun pengurus KUD, email resmi, dan kata sandi akses.</p>
        </div>
        ...
        <div class="card card-custom p-4 p-md-5 mb-4">
            ...
            <div class="d-flex flex-column flex-sm-row align-items-center gap-3.5 pb-4 mb-4 border-bottom">
                <div class="rounded-circle bg-indigo text-white d-flex align-items-center justify-content-center fw-bold fs-2 shadow-sm" style="width: 72px; height: 72px; background: linear-gradient(135deg, #6366f1 0%, #4f46e5 100%);">
                ...
                <div class="text-center text-sm-start">
                    ...
                    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-sm-start gap-2">
                        <span class="badge bg-indigo-subtle text-primary border border-primary-subtle px-2.5 py-1">
            ...
            <form action="{{ route('kud.profile.update') }}" method="POST">
                ...
                <h6 class="fw-bold text-dark mb-3">Informasi Akun KUD</h6>
                ...
                <div class="d-flex justify-content-end gap-2.5">
                    <a href="{{ route('kud.dashboard') }}" class="btn btn-light px-4 py-2 fw-semibold text-secondary">Batal</a>
