        ...
        <div class="p-3 border-top border-light-subtle">
            <div class="d-flex align-items-center gap-2 mb-3">
                ...
                <div class="overflow-hidden">
                    <div class="fw-bold small text-truncate">{{ Auth::user()->username ?? 'Pengurus KUD' }}</div>
                    <div class="text-muted small" style="font-size: 0.75rem;">Petugas KUD</div>
                </div>
            </div>
    ...
    <div class="main-wrapper">
        ...
        <header class="top-navbar d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex align-items-center gap-2">
                <span class="badge text-bg-warning-subtle text-warning-emphasis px-3 py-1.5 rounded-pill small fw-semibold">
                    <i class="bi bi-shop me-1"></i> Panel Koperasi Unit Desa (KUD)
                </span>
